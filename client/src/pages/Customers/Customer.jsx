...
navigate("/clients");
  ...
  return (
    <div className="customer">
      ...
      <h1>Ses Requetes</h1>
    <FetchTab sizeTab={475} linkFetch={"/requests/customer/"+id} linkNew={'/requetes/nouveau?customer='+id} columns={columns} parser={ParseRequest} titleNew={"Lui rajoutez une nouvelle reuqete"} />
    </div>
  );
};
